...
TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_121.
...
READ ENTITY zi_travel_m_121\\travel FROM VALUE #(
...
MODIFY ENTITIES OF zi_travel_m_121 IN LOCAL MODE
       ENTITY travel
  ...
  READ ENTITIES OF zi_travel_m_121 IN LOCAL MODE
       ENTITY travel
...
READ ENTITY zi_travel_m_121 FROM VALUE #( FOR keyval IN keys
                                                  (  %key                    = keyval-%key
